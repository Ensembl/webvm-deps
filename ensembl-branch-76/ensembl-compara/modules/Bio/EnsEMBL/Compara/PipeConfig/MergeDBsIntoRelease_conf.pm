...
sub default_options {
    ...
    return {
        ...
        'urls'              => {
            ...
            'prev_rel_db'   => 'mysql://ensro@ens-livemirror/ensembl_compara_75',   # <----- make sure this refers to the previous release!

                                        # make sure that for the rest of the databases you have servers' and owners' names right:
            'curr_rel_db'   => 'mysql://ensadmin:'.$self->o('password').'@compara5/mp12_ensembl_compara_'.$self->o('ensembl_release'),

            'protein_db'    => 'mysql://ensro@compara3/mm14_protein_trees_'.$self->o('ensembl_release').'b',
            'ncrna_db'      => 'mysql://ensro@compara4/mp12_compara_nctrees_'.$self->o('ensembl_release').'b',
