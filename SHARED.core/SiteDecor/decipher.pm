...
# Last Modified: $Date: 2009-08-24 15:40:37 $
# Id:            $Id: decipher.pm,v 1.9 2009-08-24 15:40:37 jc3 Exp $
# Source:        $Source: /repos/cvs/webcore/SHARED_docs/lib/core/SiteDecor/decipher.pm,v $
# $HeadURL$
#
package SiteDecor::decipher;
...
our $VERSION = do { my @r = (q$Revision: 1.9 $ =~ /\d+/gmx); sprintf '%d.'.'%03d' x $#r, @r };
our $JSFILES = {
    'urchin.js'                 => q(), 
    'jquery.tablesorter.min.js' => q(),
    'jquery.james.min.js'       => q(),
	       };
...
sub site_footers {
  ...
  return qq(
    <div id="collapseFOOT">
      <div id="contact">
        <p id="email"><a href="http://www$dev.sanger.ac.uk/feedback/">decipher\@sanger.ac.uk</a></p>
