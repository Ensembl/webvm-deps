...
# Last Modified: $Date: 2012-05-22 13:31:17 $
# Id:            $Id: wtsi.pm,v 6.35 2012-05-22 13:31:17 nb5 Exp $
# Source:        $Source: /repos/cvs/webcore/SHARED_docs/lib/core/SiteDecor/wtsi.pm,v $
# $HeadURL$
#
package SiteDecor::wtsi;
...
our $VERSION = do { my @r = (q$Revision: 6.35 $ =~ /\d+/gmx); sprintf '%d.'.'%03d' x $#r, @r };
our $JSFILES = {
		'zebra.js'         => q(),
		'sidebar.js'       => q(),
		'toggle.js'        => q(),
...
sub site_headers {
  ...
  my $site_headers = qq(
    <div id="collapseHEAD" style="background:url($statichost/header-icons/swoosh/@{[$self->swoosh()]}) no-repeat top left;" >
      ...
      <div id="searchbox">
        <form action="http://www.sanger.ac.uk/search/s/" method="post">
          <input id="q">
          <input type="hidden" value="all" name="domain">
        </form>
      </div><!--search box end-->
  ...
  return qq(
    <div id="collapseFOOT">
      ...
      <div id="legal">
        ...
        <p class="middle">@{[($self->decor() eq "printable")?q():qq(<a href="/help/">Help</a> \| <a href="/about/contact/">Contact us</a> \| <a href="/legal/">Legal</a> \| <a href="/legal/cookiespolicy.html">Cookies policy</a> \| <a href="/datasharing/">Data sharing</a> )]}</p>
      </div>
