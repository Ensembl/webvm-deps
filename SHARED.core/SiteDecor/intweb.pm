...
# Last Modified: $Date: 2011-11-11 10:34:52 $
# Id:            $Id: intweb.pm,v 1.12 2011-11-11 10:34:52 nb5 Exp $
# Source:        $Source: /repos/cvs/webcore/SHARED_docs/lib/core/SiteDecor/intweb.pm,v $
# $HeadURL$
#
package SiteDecor::intweb;
...
our $VERSION = do { my @r = (q$Revision: 1.12 $ =~ /\d+/gmx); sprintf '%d.'.'%03d' x $#r, @r };
our $JSFILES = {
		'urchin.js'	   => q(),
		'zebra.js'         => q(),
		'sidebar.js'       => q(),
...
sub site_headers {
  ...
  my $site_headers = qq(
    <div id="collapseHEAD" style="background:url($statichost/header-icons/swoosh/@{[$self->swoosh()]}) no-repeat top left;" >
      ...
      <div id="searchbox">
        <form action="http://search.sanger.ac.uk/IntranetSearch/search.jsp"name="sitesearch">
          <input type="text"name="query"value=""size="12"maxlength="100"id="q"class="sitequery"/>
  ...
  return qq(
	...
	urchinTracker();
      ...
      <div id="legal">
        ...
        <p class="left">Genome Research Limited is a charity registered in England with number 1021457</p>
        <p class="middle">@{[($self->decor() eq "printable")?q():qq(<a href="http://intweb$dev.sanger.ac.uk/datasharing">Data Sharing Policy</a> | <a href="http://www$dev.sanger.ac.uk/notices/use-policy.shtml">Conditions of Use</a> | <a href="http://www$dev.sanger.ac.uk/notices/copyright.shtml">Copyright</a>)]}</p>
      </div>
