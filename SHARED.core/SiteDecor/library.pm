...
# Last Modified: $Date: 2009-12-16 10:15:01 $
# Id:            $Id: library.pm,v 1.2 2009-12-16 10:15:01 nb5 Exp $
# Source:        $Source: /repos/cvs/webcore/SHARED_docs/lib/core/SiteDecor/library.pm,v $
# $HeadURL$
#
package SiteDecor::library;
  ...
  return qq(
    <div id="collapseFOOT">
      ...
      <div id="legal">
        ...
        <p class="middle">@{[($self->decor() eq "printable")?q():qq(<a href="http://www$dev.sanger.ac.uk/notices/datasharingpolicy.shtml">Data Sharing Policy</a> | <a href="http://www$dev.sanger.ac.uk/notices/use-policy.shtml">Conditions of Use</a> | <a href="http://www$dev.sanger.ac.uk/notices/copyright.shtml">Copyright</a>)]}</p>
      </div>
